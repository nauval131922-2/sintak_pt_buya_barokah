    ...
    <div className="space-y-6">
      ...
      <div className="p-4 bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800/60 rounded-xl flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
              Simulator Buku Manasik Haji / Umroh
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold bg-white dark:bg-zinc-800 text-emerald-700 dark:text-emerald-300 border border-emerald-300 dark:border-emerald-700 rounded-lg hover:bg-emerald-50 shadow-sm transition"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-5">
          ...
          <div className="bg-gradient-to-br from-emerald-600 to-teal-700 text-white rounded-xl p-6 shadow-md">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              <div>
                <div className="text-emerald-100 text-xs font-medium">HPP Satuan</div>
                <div className="text-2xl font-bold mt-1">
                  Rp {result.summary.hppPerPcs.toLocaleString('id-ID')}
                </div>
                <div className="text-xs text-emerald-200 mt-0.5">
                  Total HPP: Rp {result.summary.totalHpp.toLocaleString('id-ID')}
                </div>
              </div>

              <div>
                <div className="text-emerald-100 text-xs font-medium">Harga Jual Normal</div>
                <div className="text-2xl font-bold mt-1">
              ...
              <div className="col-span-2 sm:col-span-1 border-t sm:border-t-0 sm:border-l border-emerald-500/50 pt-3 sm:pt-0 sm:pl-4">
                <div className="text-emerald-100 text-xs font-medium">Total Nilai Order</div>
                ...
                <div className="text-xs text-emerald-200 mt-0.5">
                  Estimasi Profit: Rp {(negoDiskonPct > 0 ? result.summary.totalProfitNego : result.summary.totalProfit).toLocaleString('id-ID')}
                </div>
              </div>
            </div>

            <div className="mt-4 pt-4 border-t border-emerald-500/40 flex flex-wrap items-center justify-between text-xs text-emerald-100 gap-2">
              <div>
                <span className="opacity-80">Metode Cover: </span>
                <span className="font-semibold">{result.metodeCoverTerpilih}</span>
              </div>
              <div>
                <span className="opacity-80">Tebal Punggung: </span>
