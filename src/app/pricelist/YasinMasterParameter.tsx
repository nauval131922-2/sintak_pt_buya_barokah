            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                {isFieldModified('hargaIsiYasin64') && (
                  <button onClick={() => handleResetField('hargaIsiYasin64')} className="text-[10px] text-amber-600 font-bold">↺ Reset</button>
                )}
              </div>
              <ThousandInput value={customParams.hargaIsiYasin64} onChange={(v) => handleChange('hargaIsiYasin64', v)} className="w-full bg-slate-50 border border-slate-300 rounded-lg p-2 font-mono text-xs font-bold" />
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                {isFieldModified('hargaIsiYasin96') && (
                  <button onClick={() => handleResetField('hargaIsiYasin96')} className="text-[10px] text-amber-600 font-bold">↺ Reset</button>
                )}
              </div>
              <ThousandInput value={customParams.hargaIsiYasin96} onChange={(v) => handleChange('hargaIsiYasin96', v)} className="w-full bg-slate-50 border border-slate-300 rounded-lg p-2 font-mono text-xs font-bold" />
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                {isFieldModified('hargaIsiYasin128') && (
                  <button onClick={() => handleResetField('hargaIsiYasin128')} className="text-[10px] text-amber-600 font-bold">↺ Reset</button>
                )}
              </div>
              <ThousandInput value={customParams.hargaIsiYasin128} onChange={(v) => handleChange('hargaIsiYasin128', v)} className="w-full bg-slate-50 border border-slate-300 rounded-lg p-2 font-mono text-xs font-bold" />
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                {isFieldModified('hargaIsiYasin192') && (
                  <button onClick={() => handleResetField('hargaIsiYasin192')} className="text-[10px] text-amber-600 font-bold">↺ Reset</button>
                )}
              </div>
              <ThousandInput value={customParams.hargaIsiYasin192} onChange={(v) => handleChange('hargaIsiYasin192', v)} className="w-full bg-slate-50 border border-slate-300 rounded-lg p-2 font-mono text-xs font-bold" />
            </div>
          </div>
        </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                {isFieldModified('tarifPrintSisipanFotoA3') && (
                  <button onClick={() => handleResetField('tarifPrintSisipanFotoA3')} className="text-[10px] text-amber-600 font-bold">↺ Reset</button>
                )}
              </div>
              <ThousandInput value={customParams.tarifPrintSisipanFotoA3} onChange={(v) => handleChange('tarifPrintSisipanFotoA3', v)} className="w-full bg-slate-50 border border-slate-300 rounded-lg p-2 font-mono text-xs font-bold" />
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                {isFieldModified('tarifCasingInHardcover') && (
                  <button onClick={() => handleResetField('tarifCasingInHardcover')} className="text-[10px] text-amber-600 font-bold">↺ Reset</button>
                )}
              </div>
              <ThousandInput value={customParams.tarifBoardHardcover + customParams.tarifCasingInHardcover} onChange={(v) => {
                handleChange('tarifBoardHardcover', Math.round(v * 0.3));
                handleChange('tarifCasingInHardcover', Math.round(v * 0.7));
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                {isFieldModified('tarifSikuSudutEmas') && (
                  <button onClick={() => handleResetField('tarifSikuSudutEmas')} className="text-[10px] text-amber-600 font-bold">↺ Reset</button>
                )}
              </div>
              <ThousandInput value={customParams.tarifSikuSudutEmas + customParams.tarifPitaRumbaiPapercraft} onChange={(v) => {
                handleChange('tarifSikuSudutEmas', Math.round(v * 0.5));
                handleChange('tarifPitaRumbaiPapercraft', Math.round(v * 0.5));
              }} className="w-full bg-slate-50 border border-slate-300 rounded-lg p-2 font-mono text-xs font-bold" />
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                {isFieldModified('tarifEmbossFoilGembos') && (
                  <button onClick={() => handleResetField('tarifEmbossFoilGembos')} className="text-[10px] text-amber-600 font-bold">↺ Reset</button>
                )}
              </div>
              <ThousandInput value={customParams.tarifEmbossFoilGembos} onChange={(v) => handleChange('tarifEmbossFoilGembos', v)} className="w-full bg-slate-50 border border-slate-300 rounded-lg p-2 font-mono text-xs font-bold" />
            </div>
          </div>
        </div>
      </div>
