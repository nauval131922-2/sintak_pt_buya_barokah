                  ...
                  <table className="w-full text-left text-xs border-collapse">
                    ...
                    <tbody className="divide-y divide-slate-100 font-medium text-slate-700">
                      {[
                        ...
                        { no: 4, kategori: 'Brosur 2026', nama: 'Brosur Custom (AP 120 / AP 150)', folder: '04. Pricelist Brosur 2026', file: 'Pricelist BROSUR 2026.xlsm', mesin: 'Oliver 58 / Print Inter', finishing: 'Laminasi Glossy/Doff/UV, Lipat, Sisir, Box' },
                        ...
                        { no: 8, kategori: 'Syahadah', nama: 'Syahadah / Piagam Kelulusan', folder: '08. Pricelist Syahadah', file: 'Pricelist Syahadah.xlsx', mesin: 'Oliver 58 / Ryobi / Print Inter', finishing: 'Potong Sisir, Packing Dus' },
                        ...
                        { no: 10, kategori: 'Kop Surat', nama: 'Kop Surat Resmi Instansi', folder: '10. Pricelist Kop Surat', file: 'Pricelist Kop Surat.xlsx', mesin: 'Oliver 58 / Ryobi / Print Inter', finishing: 'Potong Sisir, Packing Box' },
                        ...
                        { no: 12, kategori: 'Sertifikat', nama: 'Sertifikat / Piagam Penghargaan', folder: '12. Pricelist Sertifikat', file: 'Pricelist SERTIFIKAT.xlsm', mesin: 'Oliver 58 / Digital A3+', finishing: 'Laminasi Glossy/Doff, Sisir, Box' },
                        { no: 13, kategori: 'Undangan', nama: 'Undangan Pernikahan / Acara', folder: '13. Pricelist Undangan', file: 'Pricelist Undangan.xlsm', mesin: 'Oliver 58 / Digital A3+', finishing: 'Laminasi Doff/Glossy, Pond Rel, OPP' },
                        ...
                        { no: 18, kategori: 'Buku Soft Cover', nama: 'Buku Soft Cover Standar (A4 / B5)', folder: '17. Pricelist Buku Soft Cover', file: 'Pricelist Buku Soft Cover.xlsx', mesin: 'Digital A3+ + Oliver', finishing: 'Laminasi Doff/Glossy/UV, Staples, Sisir, Box' },
                        { no: 19, kategori: 'Buku Soft Cover 14,5×20,25', nama: 'Buku Soft Cover Sedang (14,5×20,25 cm)', folder: '18. Pricelist Buku Soft Cover - 14,5 x 20,25 cm', file: 'Pricelist Buku Soft Cover - 14,5 x 20,25 cm.xlsx', mesin: 'Digital A3+ + Oliver/Ryobi', finishing: 'Laminasi Doff/Glossy, Lem Panas / Staples, Sisir' },
                        { no: 20, kategori: 'Buku Hard Cover 10,5×14,8', nama: 'Buku Hard Cover Saku (10,5×14,8 cm)', folder: '18. Pricelist Hard Cover - 10,5 x 14,8 cm', file: 'Pricelist Buku Hard Cover 10,5 x 14,8 cm.xlsx', mesin: 'Digital A3+ + Oliver/Ryobi', finishing: 'Laminasi Doff/Glossy, Board No. 30/40, Casing-In' },
                        ...
                        { no: 24, kategori: 'Stiker', nama: 'Stiker Cromo & Vinyl Die Cut', folder: '23. Pricelist Stiker', file: 'Pricelist Stiker.xlsx', mesin: 'Oliver 58 / Digital A3+', finishing: 'Rajang / Half Cut, Laminasi Glossy, Box' },
                        { no: 25, kategori: 'Buku Soft Cover 10,5×14,8', nama: 'Buku Soft Cover Saku (10,5×14,8 cm)', folder: '24. Pricelist Buku Soft Cover - 10,5 x 14,8 cm', file: 'Pricelist Buku Soft Cover - 10,5 x 14,8 cm.xlsx', mesin: 'Digital A3+ + Oliver/Ryobi', finishing: 'Laminasi Doff/Glossy/UV, Staples, Sisir, Box' },
                        { no: 26, kategori: 'Buku Hard Cover 14,5×20,25', nama: 'Buku Hard Cover Sedang (14,5×20,25 cm)', folder: '25. Pricelist Hard Cover - 14,5 x 20,25 cm', file: 'Pricelist Buku Hard Cover 14,5 x 20,25 cm.xlsx', mesin: 'Digital A3+ + Oliver', finishing: 'Laminasi Doff/Glossy, Board No. 30, Casing-In' },
                        { no: 27, kategori: 'Buku Hard Cover 21×29,7', nama: 'Buku Hard Cover Besar / Skripsi (A4)', folder: '26. Pricelist Hard Cover - 21 x 29,7 cm', file: 'Pricelist Buku Hard Cover 21 x 29,7 cm.xlsx', mesin: 'Digital A3+ + Oliver/SM', finishing: 'Laminasi Doff/Glossy, Board No. 30, Casing-In' },
