...
import {
  ...
  recalculateBukuHardCover145x2025Matrix,
...
export default function BukuHardCover145x2025MatrixView({
  customParams,
  ...
  const matrixData = useMemo(() => {
    return recalculateBukuHardCover145x2025Matrix(
      customParams,
      finishing,
      opsiFoil,
      marginPct,
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="font-black text-slate-800 text-sm sm:text-base">
                Pricelist Matriks Buku Hard Cover 14,5×20,25 cm
              </h3>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Matriks harga across 23 tier oplah (50 s/d 5.000 pcs) Buku Hard Cover 100 Halaman (14,5×20,25 cm).
            </p>
          </div>
        </div>
