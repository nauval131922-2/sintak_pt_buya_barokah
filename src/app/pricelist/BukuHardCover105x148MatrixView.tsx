...
import {
  ...
  recalculateBukuHardCover105x148Matrix,
...
export default function BukuHardCover105x148MatrixView({
  customParams,
  ...
  const matrixData = useMemo(() => {
    return recalculateBukuHardCover105x148Matrix(
      customParams,
      finishing,
      opsiFoil,
      marginPct,
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="font-black text-slate-800 text-sm sm:text-base">
                Pricelist Matriks Buku Hard Cover 10,5×14,8 cm
              </h3>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Matriks harga across 23 tier oplah (50 s/d 5.000 pcs) Buku Hard Cover 100 Halaman (A6).
            </p>
          </div>
        </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[9px] font-extrabold uppercase px-1.5 py-0.5 rounded bg-slate-100 text-slate-600 border border-slate-200">
                    {item.prosesCetak.includes('Print - Isi Print')
                      ...
                      ? 'Ryobi'
                      : item.prosesCetak.includes('Isi SM')
                      ? 'SM 52'
                      : 'Oliver'}
                  </span>
                </div>
