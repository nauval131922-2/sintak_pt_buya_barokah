...
export default function MajalahMatrixView({
  customParams,
  ...
  const matrixData = useMemo(() => {
    return recalculateMajalahMatrix(
      customParams,
      finishing,
      jilid,
      marginPct,
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="font-black text-slate-800 text-sm sm:text-base">
                Pricelist Matriks Majalah 14,5×20,25 cm
              </h3>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Matriks harga 20 tier oplah (20 s/d 3.000 pcs) Majalah Full Colour 32 Halaman terhitung instan.
            </p>
          </div>
        </div>
