...
export default function PosterMatrixView({
  customParams,
  ...
  const matrixData = useMemo(() => {
    return recalculatePosterMatrix(
      customParams,
      finishing,
      marginPct,
      negoPct
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Matriks harga 4 ukuran poster across tier oplah terhitung instan dari Master Parameter.
            </p>
          </div>
        </div>
            ...
            <table className="w-full text-xs text-left border-collapse">
              <thead>
                <tr className="bg-slate-100 text-slate-700 border-b border-slate-200 text-[11px]">
                  ...
                  <th className="py-2.5 px-3 font-bold">Ukuran Poster</th>
