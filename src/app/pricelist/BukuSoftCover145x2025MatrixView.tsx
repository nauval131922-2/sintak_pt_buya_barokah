...
import {
  ...
  recalculateBukuSoftCover145x2025Matrix,
...
export default function BukuSoftCover145x2025MatrixView({
  customParams,
  ...
  const matrixData = useMemo(() => {
    return recalculateBukuSoftCover145x2025Matrix(
      customParams,
      finishing,
      jilid,
      marginPct,
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="font-black text-slate-800 text-sm sm:text-base">
                Pricelist Matriks Buku Soft Cover 14,5×20,25 cm
              </h3>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Matriks harga bertingkat across 25 tier oplah (20 s/d 3.000 pcs) terhitung instan dari Master Parameter.
            </p>
          </div>
        </div>
