...
export default function PosterSimulator({
  ...
  useEffect(() => {
    ...
    try {
      localStorage.setItem(DRAFT_KEY, JSON.stringify({ ukuran, oplah, finishing, marginPct, negoDiskonPct }));
    } catch { /* abaikan */ }
  }, [ukuran, oplah, finishing, marginPct, negoDiskonPct, activeSimulationId]);
