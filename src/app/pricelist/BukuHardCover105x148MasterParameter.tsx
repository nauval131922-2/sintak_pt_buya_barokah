...
export default function BukuHardCover105x148MasterParameter({
  ...
  const isFieldModified = (key: keyof BukuHardCover105x148MasterParams) => {
  ...
  const handleResetField = (key: keyof BukuHardCover105x148MasterParams) => {
    setCustomParams((prev) => ({
      ...prev,
      [key]: DEFAULT_BUKU_HARD_COVER_105X148_PARAMS[key],
    }));
  };
  ...
  const handleChange = (
    key: keyof BukuHardCover105x148MasterParams,
    value: string,
    isFloat = false
  ) => {
      ...
      >
        <div className="flex flex-col min-w-0 pr-2">
          ...
          <span className="text-[10px] text-slate-400">
            Def:{' '}
            {isCurrency
              ? `Rp ${DEFAULT_BUKU_HARD_COVER_105X148_PARAMS[key].toLocaleString('id-ID')}`
              : `${DEFAULT_BUKU_HARD_COVER_105X148_PARAMS[key]}${key.includes('Pct') ? '%' : ''}`}
          </span>
        </div>
    ...
    <div className="flex flex-col gap-4 pb-8">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="font-black text-slate-800 text-sm sm:text-base">
                Master Parameter Buku Hard Cover 10,5×14,8 cm
              </h3>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Tarif bahan, board casing, mesin bertingkat (Print, Ryobi, Oliver, SM), dan jilid Hard Cover.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-2xs flex flex-col gap-3">
          ...
          <p className="text-[10px] text-slate-500">
            Lipat, susun, jahit benang, lem press, headband, pita, pilung, casing in, dan packing kardus @ 60 pcs.
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-2xs flex flex-col gap-3">
          ...
          <p className="text-[10px] text-slate-500">
            Luas cover terbuka: 22,5 × 16,35 cm = ~368 cm². Margin standar 30%, Nego 5%.
          </p>
        </div>
      </div>
          ...
          >
            <div className="px-6 py-4 bg-emerald-900 text-white flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-base">Panduan Parameter Buku Hard Cover 10,5×14,8 cm</h3>
                  <p className="text-xs text-emerald-200">Referensi: Pricelist Buku Hard Cover 10,5 x 14,8 cm.xlsx</p>
                </div>
              </div>
              <button
                type="button"
            ...
            <div className="p-6 overflow-y-auto space-y-4 text-xs text-slate-600 leading-relaxed">
              <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl space-y-1">
                <h5 className="font-bold text-slate-800 flex items-center gap-1.5">
                  ...
                  Spesifikasi Standar Buku Hard Cover A6
                </h5>
                <p>
                  Ukuran tertutup 10,5 × 14,8 cm (A6). Cover Hard Cover Art Paper 150 gsm 1 Muka Full Colour + Board tebal No. 30/40.
              ...
              <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl space-y-1">
                <h5 className="font-bold text-slate-800 flex items-center gap-1.5">
                  ...
                  Alur Proses Mesin Produksi Bertingkat
                </h5>
                <ul className="list-disc list-inside space-y-1 pl-1">
                  <li><strong>Oplah 50–250 pcs</strong>: Cover Print Inter A3+ + Isi Print Buya A4</li>
                  <li><strong>Oplah 300–500 pcs</strong>: Cover Print Inter A3+ + Isi Ryobi Offset 1W (25 Plat)</li>
                  <li><strong>Oplah 600–1000 pcs</strong>: Cover Print Inter A3+ + Isi Oliver Offset 1W (8 Plat)</li>
                  <li><strong>Oplah 1500–2500 pcs</strong>: Cover Oliver Offset 4W (4 Plat) + Isi Oliver Offset 1W (8 Plat)</li>
                  <li><strong>Oplah 3000–5000 pcs</strong>: Cover Oliver Offset 4W (4 Plat) + Isi Heidelberg Speedmaster 52</li>
                </ul>
              </div>
