  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="card overflow-hidden border-gray-200/60 shadow-sm rounded-xl">
        <div className="border-b border-gray-100 flex items-center justify-between gap-3">
        ...
        {loading ? (
          ...
          <div className="divide-y divide-gray-50" key={'pending-' + pendingUsers.length + '-' + (pendingUsers[0]?.id || 'none')}>
            {pendingUsers.map(user => (
              <div key={user.telegram_id} className="flex items-center gap-3 hover:bg-gray-50/60 transition-colors">
