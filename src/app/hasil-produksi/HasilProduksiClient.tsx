          ...
          <div id="desktop-sticky-control-bar" className="shrink-0 z-[30] bg-white/80 backdrop-blur-md border border-white/20 rounded-xl shadow-sm transition-all relative">
            ...
            <div className="sm:hidden flex items-center justify-between px-3 py-2 bg-slate-50/70 hover:bg-slate-100/80 transition-colors border-b border-slate-100 rounded-t-xl">
              ...
              >
                ...
                <span className="text-[11px] font-bold text-slate-800 truncate">Status Produksi & Tampilan</span>
                <div className="flex items-center space-x-1 text-slate-500 text-[10.5px] font-medium ml-auto pr-1 shrink-0">
            ...
            <div className={`${isControlOpenMobile ? "flex flex-col" : "hidden sm:flex sm:flex-col"} md:flex-row items-stretch md:items-center justify-between gap-2.5 p-1.5 sm:p-2 animate-in fade-in slide-in-from-top-1 duration-200`}>
              ...
              <div className="flex-1 min-w-[140px] max-w-xl mx-1 bg-gray-50/80 border border-gray-200/60 rounded-lg px-2 sm:px-2.5 h-8 flex items-center gap-2">
                ...
                <div className="flex-1 flex items-center gap-2 min-w-0">
                  ...
                  <span className="text-[11px] font-bold tabular-nums text-gray-700 shrink-0">
