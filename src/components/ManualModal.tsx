...
export default function ManualModal() {
  ...
  const allGuides = useMemo(() => ({
    ...
    '/pricelist': {
      ...
      description: 'Master data tarif dasar, simulator HPP & harga penawaran kustom, kalkulasi profit, dan matriks harga cetak terintegrasi untuk seluruh lini produk percetakan PT Buya Barokah.',
      steps: [
        '**Pemilihan Kategori Produk**:',
        '  • Gunakan dropdown **Jenis Produk** di header sub-menu untuk memilih kategori produk yang ingin dihitung atau disimulasikan.',
        '  • Seluruh tab (**Daftar Kalkulasi**, **Master Parameter**, **Simulator**, dan **Pricelist**) otomatis tersinkronisasi mengikuti kategori aktif.',
        '**A. Master Parameter Global & Spesifik Produk**:',
        '  • **Master Global**: Klik tombol **"Master Global"** di samping dropdown produk untuk mengatur tarif bersama yang berlaku lintas semua produk (harga kertas dasar per kg, mesin offset Oliver, print digital A3+, laminasi, dan packing).',
        '  • **Master Parameter Produk**: Mengatur komponen dan ongkos yang bersifat spesifik per produk (blok isi, jenis jilid/finishing khusus, nomorator, royalti, dll.).',
        '  • Klik tombol **Reset Standar Master** untuk mengembalikan kolom input ke setelan baku.',
        '**B. Simulator (Kalkulator Estimasi Biaya & HPP)**:',
        '  • Masukkan spesifikasi order (oplah, format/ukuran, jumlah halaman/muka, jenis jilid/finishing, bahan, dsb.).',
        '  • Atur target **Margin Profit (+%)** dan toleransi **Diskon Nego (-%)**.',
        '  • Pantau **4 Kartu Finansial** (HPP, Harga Jual Standar, Harga Nego, dan Total Nilai Order) beserta tabel **Rincian Komponen Biaya**.',
        '  • Tombol **Salin Penawaran**: Menyalin teks penawaran harga terformat rapi untuk langsung dikirim ke WhatsApp klien.',
        '  • Tombol **Simpan Kalkulasi**: Menyimpan kalkulasi ke riwayat lokal browser Anda.',
        '**C. Pricelist Matriks (Tabel Harga Cepat)**:',
        '  • Menampilkan matriks tabel harga jual, harga nego, HPP, dan margin profit berdasarkan kombinasi ukuran/varian dan tier oplah.',
        '  • Switcher **Matriks / Tabel Rinci**: Gunakan toggle di kanan atas tabel untuk beralih antara tampilan matriks visual atau flat table dengan fitur pencarian instan.',
        '**D. Daftar Kalkulasi Tersimpan**:',
        '  • Menampilkan seluruh riwayat simulasi yang pernah Anda simpan, lengkap dengan filter kategori produk, status, tanggal, dan tombol untuk memuat ulang ke simulator.'
      ],
      tips: 'Setiap kali Anda memperbarui Master Parameter (baik Global maupun per produk), seluruh kalkulasi pada Simulator dan tabel Pricelist Matriks akan langsung terhitung ulang seketika secara dinamis tanpa perlu reload.'
    },
    '/hasil-produksi': {
