...
export default function StatCardDropdown({
  ...
  const badgeBase = `flex items-center gap-1 text-[10px] font-bold px-2 py-0.5 rounded-full transition-colors border`;
              ...
              filtered.map((opt) => (
                ...
                >
                  ...
                  <span className="flex items-center gap-1 shrink-0 ml-2">
                    {opt.count !== undefined && (
                      <span className="text-[10px] text-gray-400 font-medium">{opt.count}</span>
                    )}
