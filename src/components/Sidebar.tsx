...
export default function Sidebar({ user, permissions = {} }: SidebarProps) {
  ...
  return (
    ...
    {isMobileOpen && (
      <div
        className="fixed inset-0 h-full w-full bg-slate-900/40 backdrop-blur-sm z-[300] xl:hidden animate-in fade-in duration-300"
    ...
    <aside
      ...
      className={`
        fixed xl:sticky top-0 h-full bg-white border-r border-gray-100 shrink-0 flex flex-col z-[350]
