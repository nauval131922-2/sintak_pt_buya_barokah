...
export const PAGE_CHANGELOGS: Record<string, PageChangelog> = {
  'pricelist-2026-09-24': entry({
    ...
    items: [
      "Kata ikut excel master buku",
      "Hapus badge lini cari sticky",
      "Kartu lanjutan terbuka penuh",
      "Badge jarang jadi lanjutan",
      "Grup catatan terbuka penuh",
    ],
  }),

  'jurnal-harian-produksi-2026-09-24': entry({
  ...
  'pricelist-2026-09-23': entry({
    ...
    items: [
      "Hapus label semua lini",
      "Hapus header master manual reset",
      "Hapus header simulator panduan salin",
      "Master masonry isi ruang kosong",
      "Master global hanya harga kertas",
      "Redesign master kalkulasi Ramah",
      "Catatan cover dinamis ikut tarif",
      "Kartu master rata atas isi sendiri",
      "Catatan cover pakai customParams",
      "Tarif print isi pindah kartu isi",
    ],
  }),
  ...
  'pricelist-2026-09-22': entry({
    ...
    items: [
      "Grup saklar jadi Komponen Tambahan",
      "Unifikasi 1 lini 8 engine 3 sumber — hapus 10 file triad lama",
      "Up cover ke grup cover + aksen warna kartu master",
      "Nama mesin lengkap 1:1 Excel di semua label",
      "PI jadi Print Inter sesuai istilah Excel",
      "Referensi cell Excel hanya di modal manual master",
      "Audit penuh 1:1 Excel — jenis/muka/warna/sisir, hapus nego, rounding puluhan",
      "Opsi aktif tengah-tengah slate-200",
      "Gramatur cover bisa disetting + reaktif",
      "Hapus produk heuristik 10,5x14,8 — gabung ke unified + migrasi riwayat",
      "Hapus istilah klasik/offset/custom di parameter",
      "Mode bebas saklar komponen, file sumber otomatis",
      "Up cover/isi custom bisa disetting + reaktif",
      "Label persen kartu harga pakai input margin",
      "Hapus nomor urut label cascade",
      "Opsi kiri netral, hijau hanya CTA simpan + hasil",
      "Sub-kelompok beraksen di tiap kartu master",
      "Audit penuh 1:1 Excel — kunci domain PI+Oliver, hapus nego, tier 12",
      "3 lini combo mesin 1:1 Excel — Oliver-Oliver, Print-Oliver, Print-Print",
      "Cascade ukuran-mesin-sumber gantikan dropdown lini + oplah ketik",
      "SubGroup keluar dari fieldRow",
      "Opsi aktif abu muda, tidak bold",
      "10 lini custom F19/F21/F24 + gabung 10,5x14,8 — 1 produk 18 lini",
      "File sumber pindah bawah grup isi",
      "Mesin cover/isi masuk aksen grupnya",
    ],
  }),
