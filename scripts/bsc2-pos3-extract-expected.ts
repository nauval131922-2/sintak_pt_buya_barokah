...
const BASE = 'E:/percetakan buya barokah/backup/a1/02__PEMASARAN/0203_SURAT PENAWARAN HARGA (SPH) out/020326 2026 SURAT PENAWARAN HARGA (SPH) out/Pricelist Juli 2026/17. Pricelist Buku Soft Cover - 21 x 29,7 cm/Source';
const FILES: Record<string, string> = {
  'Oliver-Oliver': 'BUKU UK. 21 x 29,7 - Cover Oliver - Isi Oliver',
  'Print-Oliver': 'BUKU UK. 21 x 29,7 - Cover Print - Isi Oliver',
  'Print-Print': 'BUKU UK. 21 x 29,7 - Cover Print - Isi Print',
};
...
async function main() {
  ...
  writeFileSync('scripts/bsc2-expected.json', JSON.stringify(out, null, 1));
  console.log('wrote scripts/bsc2-expected.json');
}
